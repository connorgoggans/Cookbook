...
\textsc{Most commercially available muscadine wine has residual sugar and is described on it's label as sweet or semi-sweet.  In addition, it has a higher ABV that the wine used here. Commercially made muscadine wine can be used for this recipe, however, adjustments must be made to account for both the extra sugar and the extra alcohol in the wine. }
