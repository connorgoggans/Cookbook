...
50 grams bakers yeast or 25 grams.}
...
Using a grain mill or food processor, mill the rice to small course pieces.  Measure the volume of the milled rice then put rise in brewing pail. Add a volume of almost boiling water equal to around three times the volume of the milled rice to the pail. Using a paint mixer and drill, agitate the mixture in the pail very well. 
...
10 teaspoons  yeast nutrient (Fermaid O);
5 tablespoons distiller's yeast (Red Star DADY);
sodium carbonate;
\quarter teaspoon Epsom salt.}

Mix 3 gallons of water with sugar and citric acid. Stir to dissolve. Bring to a boil and then boil for 20 minutes. Turn off fire and cool for 1 hour. Combine invert sugar syrup with 9 gallons of water. Add half the yeast nutrient and Epson salt and stir.  Add distillers yeast and stir.  Check PH and adjust to between 4.4 and 5.4.  To raise PH add 1 tablespoon of sodium carbonate. Measure SP and record. The SP should be close to 1.092 (12.08 potential ABV). When SP drops by 30 percent and the second half of the yeast nutrient. 

Distilling the 12 gallons of wash in striping runs should result in 3 gallons of 40\% AVB low wines.  Add sodium carbonate (washing soda) at a rate of 1 teaspoon per liter of low wines.  Add a few liters of water to the low wines to help it distill.  Make a spirits run.  The spirits run should result in 1 gallon of hearts at 75 percent from a pot still or 3 liters of 85 percent with thumper.  For the best results filter diluted spirits with a carbon filter.
...
\recipe{Gin Recipe Idea - Mango Mulberry Gin}

\ingredients{1 liter 40\% ABV neutral spirits;
7.45 grams dried mango;
\half teaspoon ground almonds;
30 grams juniper berries;
2 grams coriander seeds;
2 pink peppercorns;
0.75 grams angelica root;
3mm piece of vanilla bean;
...
\recipe{Gin Recipe Idea - Bombay Sapphire}
...
1.5 grams cassia bark;
1.5 grams cubeb berries;
