...
Fresh herbs such as dill, tarragon, basil, thyme and oregano can be added to the vinaigrette as desired.  Pick one of the above and add 1\half teaspoons to the dressing. 
...
$$ \SI{3}{\milli\meter} \approx \SI[fraction-function=\frac]{1/8}{inch}$$
$$ \SI{4.5}{\milli\meter} \approx \SI[fraction-function=\frac]{3/16}{inch}$$
$$ \SI{6}{\milli\meter} \approx \SI[fraction-function=\frac]{1/4}{inch}$$
$$ \SI{10}{\milli\meter} \approx \SI[fraction-function=\frac]{3/8}{inch}$$
$$ \SI{16}{\milli\meter} \approx \SI[fraction-function=\frac]{5/8}{inch}$$
...
\recipe{Glow-Sour}
%\hyperref[TumericGin]{Tumeric Infused Gin}
...
300 grams fresh ripe mulberries or 60 grams dried black mulberries;
500 ml of approximately 74\% ABV gin.\\
\\
\textsc{Mulberry Syrup}
75 grams fresh ripe mulberries or 15 grams dried black mulberries;
150 grams sugar;
75 ml water.
}
...
\recipe{Muscadine Liqueur Gin -- In Development}


\ingredients{\\
\\
\textsc{Muscidine Syrup}
300 grams hulls from very-ripe  dark-colored muscadines (e.g. Carlos);
600 grams sugar; 300 ml water.\\
\\
\textsc{Gin Concentrate}
...
1165 ml 8\% ABV unsweetened muscadine wine;
435 ml 95\% ABV neural spirits.
}

\textsc{This recipe requires unsweetened muscadine wine that is easiest obtained by making your own. The wine used here was made using red muscadines and no additional sugar hence the low 8\% ABV. The volume of wine and neutral sprits given assume  8\% ABV wine and yield 3.2 liters of 40\% ABV liqueur. }
