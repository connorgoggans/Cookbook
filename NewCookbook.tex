...
% See the example in the body of the report for how to actually create the table
...
Strain the broth through a large colander and discard the solids. Refrigerate until the fat has solidified and can be easily removed. Should yield 3 quarts of stock.  The gumbo uses 1\half to 2 quarts of stock. The extra stock can be frozen and used for another purpose.
...
In an 8 cup glass measuring cup combine the flour and the oil.  Using the recipe given elsewhere in these notes, make a very \hyperref[BrownRoux]{dark roux} using the microwave oven. When roux is a deep chocolate color, add the celery, onions, bell pepper, garlic and thyme to the measuring cup, stir until blended, and cook in the roux until the onion is tender. If any oil as risen to the top, pour this off.
...
16-ounce box extra-firm tofu, grained and gently pressed;
...
\recipe{Turkey Gravy}
\label{TurkeyGravy}
\ingredients{unsalted butter; all-purpose flour; turkey bone broth or chicken stock; drippings from roast turkey.}
...
Stir all ingredients with ice and strain into a chilled glass.  Garnish with a lemon twist if desired.


\recipe{Southern Slipper}
\ingredients{1\half ounce \hyperref[CantaloupeLiqueur]{Cantaloupe Liqueur};
1 ounce Cura\c{c}ao or Triple Sec;
\half ounce Luxardo maraschino liqueur;
1 ounce fresh lemon juice;
Luxardo maraschino cherry.}

Shake all liquid ingredients with ice, then stain into a chilled coupe or Nick and Nora glass. Garnish by dropping a Luxardo maraschino cherry in the glass and letting it sink to the bottom.
...
Prepare the syrup by bring the water and sugar to a boil and then reducing heat to a simmer and stirring until the sugar is completely dissolved. Cool the syrup to room temperature before adding it to flavored alcohol. Stir well to combine, seal the jar and let it rest for 1 week before proceeding.

Filter the liqueur using a double layer of muslin moistened with alcohol. Filter again and returned to rinsed bottle. Seal the bottle and place it where it will not be disturbed to allow the fine particles to settle to the bottom.  When the liquid above thin layer of particles on the bottom of the bottle is very clear, rack off the clear liquid and transfer to an attractive bottle.
...
\textsc{Making neutral spirits from scratch that is neutral enough to use in gin making requires a column still and a carbon filtering apparatus. Because of this most people are better off purchasing neutral spirits from the liquor store. For this recipe you can use either bottom shelf 80 proof vodka or Everclear diluted to 40\% ABV. I don't crush the juniper berries in this recipe for two reasons. First, using crushed berries gives inconsistent results because is it difficult to crush uniformly and consistently. Second, I find that crushed berries release harsh flavors that whole berries do not. For similar reasons I don't macerate the botanicals in the spirits before distilling. I put the fresh citrus zest in the gin basket because I like the fresh citrus flavor that results better than the marmalade like flavor that results from putting the zest into the still with the spirits.  Discarding the first 25 ml of distillate is done to control the amount of juniper and citrus oil in the final product.  Without this step the gin is likely to louch (turn cloudy) when water is added to it and have too much juniper and citrus flavor. }
...
\recipe{Making Multiple Bottles of Gin with One Run using an Air-Still}

\textsc{The maximum fill level of the Still Spirits Air-Still is 4 liters so you can scale the given recipe by 2 or 3 without exceeding the capacity of the still. For a times 2 or times 3 recipe run is it only necessary to collect and discard the first 25 ml of distillate.  When starting with 2 liters of neural spirits for a times 2 run the time to first drip from the still is 32 minutes. After the first 25 ml, collect 850-900 ml of the distillate to make the gin.}
...
\ingredients{1 liter 40\% ABV neutral spirits;
30 grams whole juniper berries;
...
\recipe{Ginger Turmeric Gin -- In Development}
\label{GingerTumericGin}

\ingredients{1 liter 40\% ABV neutral spirits;
15 grams juniper berries, whole;
7.5 grams coriander seeds, whole; 
1.5 grams angelica root, coarsely ground;
0.5 grams fresh ginger root, unpeeled and coarsely chopped;
0.5 grams fresh turmeric root, unpeeled and coarsely chopped;
fresh lemongrass;
1.5 grams liquorice root, coarsely ground;
0.5 grams dried bitter orange peel;
0.5 grams dried lemon peel;
1 gram fresh orange zest;
1 gram fresh lemon zest.}
% 10 grams Ginger Turmeric tea;
...
\recipe{Cerulean Gin}
\label{CeruleanGin}
\ingredients{750 ml Gin made with \hyperref[GinExtract]{Gin Extract}; butterfly-pea tea teabag.}
...
\newpage
 ...
 \recipe{Mulberry Gin}
 \label{MulberryGin}
 \ingredients{280 grams fresh ripe mulberries;
 500 ml of approximately 74\% ABV gin;
 mulberry simple syrup containing approximately 50 grams of sugar.}
 
 In northern Mississippi mulberries usually ripen during the last weeks of May so this is the time to make this gin. Place fresh mulberries and undiluted gin in a 1 quart Mason jar. Place the jar in a dark pantry for a couple of months. 
 
 While fresh mulberries are available, make a one-to-one simple syrup adding fresh mulberries while the syrup is hot. When cool, strain the syrup to remove the mulberries and place strained syrup in the refrigerator until needed to sweeten and proof down the gin.
 
 After a couple of months, strain the gin off of the mulberries pressing to extract as much gin and mulberry juice as possible.  Measure the volume of the extracted gin.  Assuming that no ethanol was lost in the maceration process, determine the volume of syrup that must be added so that the final mulberry gin is approximately 40\% ABV.  Bottle in 325 ml clear bottles. Makes around 1 liter of mulberry gin.

\recipe{40\% ABV Neural Spirits}

\ingredients{1,270 ml Everclear; 1,730 ml purified water.}

To make 3 liters of neural spirits at 40\% ABV mix 1,270 ml of Everclear with 1,730 ml of purified water.

\recipe{45\% ABV Neural Spirits}

\ingredients{355 ml Everclear; 395 ml purified water.}

To make 750 ml of neural spirits at 45\% ABV mix 355 ml of Everclear with 395 ml of purified water.
...
\recipe{Gin Recipe Idea - Beefeater} 
...
\textsc{Beefeater previously bottled its gin at 94 proof (47 \% ABV).  Now, Beefeater is sold at 88 proof (44 \% ABV). The botanicals used in Beefeater are according to an article in Vinepair.}
    ...
    \begin{tabular}{@{}p{1.25in}p{3in}p{1.25in}@{}}
      ...
      Botanical &  Comment & Amount per liter \\
        \midrule
 		...
 		Coriander Seeds & Lemon and subtle spice  & 2-5 grams \\
		Orris Root & Light slightly perfumed Parma violet & 0.15 grams \\
		Angelica Root &  Deep, earthy, musky & 1 gram \\
        \bottomrule
    \end{tabular}
    \label{tab:essential}
\end{table}
...
\begin{table}[hb]
    ...
    \begin{tabular}{@{}p{1.25in}p{3in}p{1.25in}@{}}
      ...
      Botanical &  Comment & Amount per liter \\
        \midrule
        Dried Lemon Peel & Concentrated flavor use sparring & 0.4-1 grams\\
        Dried Bitter Orange Peel & Concentrated flavor  use sparring & 0.48-1.2 grams\\
...
\begin{table}[hb]
    ...
    \begin{tabular}{@{}p{1.25in}p{3in}p{1.25in}@{}}
      ...
      Botanical &  Comment & Amount per liter \\
		...
		Vanilla bean & Strong flavor use sparring & 0.2 grams \\
\end{tabular}
    \label{tab:sweet}
\end{table}
...
\begin{table}[hb]
    ...
    \begin{tabular}{@{}p{1.25in}p{3in}p{1.25in}@{}}
      ...
      Botanical &  Comment & Amount per liter \\
		...
		Fresh Mint & Refreshing and strong in flavor use sparring & 0.1-0.5 grams\\
		Fresh Thyme & Delicate background herb & 0.5-1 grams \\
		Dried Hops & Strong in flavor use sparring & 1 or 2 compressed pieces\\
...
\begin{table}[hb]
    ...
    \begin{tabular}{@{}p{1.25in}p{3in}p{1.25in}@{}}
      ...
      Botanical &  Comment & Amount per liter \\
		...
		Dried Lavender Flowers & Fragrant and strong use sparring & 0.1-0.2 grams \\
		Dried Elderflower & Floral but quite powerful use sparring & \quarter to \half teaspoon \\
...
\begin{table}[hb]
    ...
    \begin{tabular}{@{}p{1.25in}p{3in}p{1.25in}@{}}
      ...
      Botanical &  Comment & Amount per liter \\
		...
		Cardamom Nibs & Strong in flavor do not crush & 0.1-0.2 grams \\
...
\ingredients{10 pounds (4.5 kg) Goya rice flour; 
...
During fermentation control the wash temperature to be 82-97\deg F (28-36\deg C). The optimal fermentation temperature about 90\deg F (32\deg C).
...
\ingredients{10 pounds (4.5 kg) Goya fine corn meal; 
4 gallons very-hot tap water;
1 teaspoon Amylase enzyme;
\half teaspoon Glucoamylase;
25 grams distiller's yeast.}
...
Add the corn flour to the brewing pail then add the hot water 3 or 4 liters at a time stirring well after each addition.  Loosely attach the pail's cover then let cool naturally to about 90\deg F (32 \deg C), agitating occasionally to prevent settling. When the wash is 90\deg F add the yeast directly to the wash and stir vigorously. Attach the pail top and the fill air lock.

During fermentation control the wash temperature to be 82-97\deg F (28-36\deg C). The optimal fermentation temperature about 90\deg F (32\deg C).
The fermentation temperature lower limit is 79\deg F (26\deg C) and the upper limit 100\deg F (38\deg C). Agitate the wash twice every day for the first three days of fermentation. At 90\deg F the wash should ferment to dry in around three days.

\newpage

\recipe{Oak-Aged Rice Spirits -- In Development}

\ingredients{1 liter \hyperref[RiceWash]{rice spirits} at around 70\% ABV; 
30 grams medium-toasted American white-oak chips;
6 one-inch cubes cut from a used bourbon barrel head.}
...
When the spirits are ready, carefully pour off of the wood into a very fine-mesh stainless steel conical-strainer and collect the strained spirits. Proof the strained spirits down to 45\% ABV and bottle.
...
If using a pot still, distilling the 12 gallons of wash in striping runs should result in 3 gallons of 40\% AVB low wines.  For a spirits run in a pot still, add sodium carbonate (washing soda) at a rate of 1 teaspoon per liter of low wines to increase the amount of hearts in the run.  Add a few liters of water to the low wines to help it distill.  Make a spirits run.  The spirits run should result in 1 gallon of hearts at 75 percent from a regular pot still or 3 liters of 85 percent with  for a pot still with a thumper.  For the best results filter diluted spirits with a carbon filter.
