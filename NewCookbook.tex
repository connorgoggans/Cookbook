...
When the cornbread comes out of the oven it time to assemble the dish. Place a cornbread round each in the bottom of four large shallow bowls. Spoon the collards and juices over the cornbread and drizzle with the hot honey. Sprinkle with peanuts and serve.
...
6 sticks plus 2 tablespoons butter;
10 medium-sized yellow-onions, peeled and cut in half;
1\half teaspoons table salt.}

\textsc{In her classic recipe for Butter-Tomato Sauce, Marcella Hazan uses plum tomatoes.  This is a sensible choice since plum tomatoes have a high flesh to juice ratio and are intended for cooking. In Mississippi plum potatoes are not common at farmers' markets but at the end of the summer Mississippi has abundant and beautiful tomatoes that are perfect for eating fresh. These these tomatoes also make great Butter-Tomato Sauce but because of their high juice to flesh ratio they require additional preparation steps to remove their excess juice before they can be used for sauce making.}

Using a large pot of boiling water and an ice bath, peel the tomatoes.  When the peeled tomatoes are cool enough to handle cut them into quarters removing any green stem or green flesh at the same time. Squeeze each quarter by hand to remove the seeds and excess juice saving the juice and seeds separately from the tomato flesh. This process should yield 20 cups of tomato flesh (adjust the a mounts of the other ingredients proportionally if you have more or less tomato flesh). Strain the juice from the seeds and save in case additional liquid is needed later in the recipe.
...
\recipe{Turkey Gravy}
\label{TurkeyGravy}
\ingredients{unsalted butter; all-purpose flour; turkey bone broth or chicken stock; drippings from roast turkey; Kitchen Bouquet Browning and Seasoning Sauce (optional); salt; pepper, freshly ground.}

In a small sauce pan, melt butter and then stir in an equal amount of flour.  Cook roux over medium heat until blond. Whisk in stock until your desired consistency is achieved. Leave at room temperature until just before serving. 

When ready to serve, reheat the roux and add defatted drippings from the roast turkey. It this gravy isn't dark enougt to suit you then add Kitchen Bouquet until it is. Season to taste with salt and pepper. Serve gravy in a gravy boat while it is still hot.
...
\textsc{Recipe from Serious Eats to be added.}
...
\textsc{Making four bottles of gin in one run requires a different approach since 4 liters of neutral plus botanicals for four bottles exceeds the capacity of an Air-Still. To make four bottles scale the botanicals in a one bottle recipe and place in still kettle or gin basket as directed in the recipe and then add 2 liters of 40\% neutral spirits to the kettle. Run the still as usual discarding the first 25 ml and then collecting 950 - 1000 ml of distillate to make the gin (let taste be your guide with collecting distillate). Dilute the collected distillate with purified water to 45 \% ABV. The result should be approximately 1500 ml of very strong flavored gin. Add 1500 ml of 45 \% ABV neural spirits to the strong gin to yield 3000 ml of gin, enough to fill four 750 ml bottles.}
...
0.5 grams dried thyme leaves or 1.5 grams of fresh thyme leaves;
0.5 grams dried lemon balm;
1.5 grams licorices root, coarsely ground;
5 grams pecan pieces, lightly toasted;
6 grams dried mulberries or 35 grams fresh blackberries or mulberries;
0.7 grams dried bitter orange peel, coarsely ground ;
0.6 grams dried Elderflower or 1.0 gram dried rose petals or 2.0 grams fresh rose petals;
...
1.5 grams angelica root, coarsely ground;
0.15 grams orris root, coarsely ground;
1.5 grams fresh ginger root, unpeeled and coarsely chopped;
1.5 grams fresh turmeric root, unpeeled and coarsely chopped;
10 grams fresh lemongrass;
1.5 grams liquorice root, coarsely ground;
%0.5 grams dried bitter orange peel;
%0.5 grams dried lemon peel;
%1 gram fresh orange zest;
2 gram fresh lemon zest.}


Set aside first 25 ml and then collect 450 ml.  Proof down to 45\% ABV.  



\recipe{Cerulean Gin}
\label{CeruleanGin}
\ingredients{750 ml Gin made with \hyperref[{GinNumber7}]{Gin \# 7}; butterfly-pea tea teabag.}
...
75 ml water.
 ...
 In northern Mississippi mulberries usually ripen during the last weeks of May so this is the time to make this gin. To make the mulberry macerate, place the fresh mulberries and undiluted gin in a 1 quart Mason jar. Put the jar in a dark pantry for a two of months. 
 ...
 After a two months, strain the gin off of the mulberries pressing to extract as much gin and mulberry juice as possible.  Measure the volume of the extracted gin.  Assuming that no ethanol was lost in the maceration process, determine the volume of syrup and additional water that must be added so that the final mulberry gin is approximately 40\% ABV. Add all the syrup and then water to bring the added volume up that necessary to achieve 40\% ABV. Bottle in 325 ml clear bottles. Makes around 900 ml of mulberry gin.
 
\newpage 


\recipe{Muscadine Gin -- In Development}


\ingredients{\\
\\
\textsc{Muscidine Macerate}
hulls from 1 liter very-ripe  dark-colored muscadines (e.g. Carlos);
500 ml of 70-75\% ABV gin.\\
\\
\textsc{Muscidine Juice}
juice from 1 liter muscidines.}
 
\recipe{1 Liter of 40\% ABV Neural Spirits}

\ingredients{420 ml Everclear; 580 ml purified water.}

To make 1 liter of neural spirits at 40\% ABV mix 420 ml of Everclear with 580 ml of purified water.
...
juniper berries;
angelica root;
angelica seeds (very difficult to find);
coriander seeds;
licorice;
almonds,
orris root;
...
\ingredients{1 liter \hyperref[RiceWash]{rice spirits} at around 55\% ABV; 
...
Using an immersion blender pur\'{e}e the carrot mixture and then then blend in buttermilk and white pepper. Serve  hot or cold.
